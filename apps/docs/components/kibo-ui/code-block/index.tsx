...
export type CodeBlockSelectProps = Omit<ComponentProps<typeof Select>, "onValueChange" | "value">;
...
const withStableLineKeys = (value: string) => {
...
const CodeBlockFallback = ({ children, ...props }: CodeBlockFallbackProps) => (
	<div {...props}>
		<pre className="w-full">
			<code>
				{children &&
					withStableLineKeys(children.toString()).map(({ key, line }) => (
